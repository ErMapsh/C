...
int main()
{
    ...
    printf("The value in array at array[1] is %d.\n", &arr[1]); // here add size of data type size of pointer
    // Using a dereferencing
    printf("The value in array at array[0] is %d.\n\n", arr + 1);

    // Pointers
    printf("The value of in array at array[0] is %d.\n", *(&arr[0]));
    printf("The value of in array at arr is %d.\n", *(arr));
    printf("The value in array at array[1] is %d.\n", *(&arr[1]));
    // Using a dereferencing
    printf("The value in array at array[0] is %d.\n", *(arr + 2));
    ...
    int *ptr = arr;// ptr acess fisrt element of address
    printf("%d\n", ptr);
    ptr++;
    printf("%d\n", ptr);
    ptr--;
